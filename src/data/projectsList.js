export const projectsList = [
  {
    ...
    projectObjective: `Ce site web a été conçu pour le club de canine pour ma mère. L'objectif était de créer une plateforme intuitive et accessible, permettant aux utilisateurs de trouver facilement les informations essentielles sur le club`,
    experienceGaind: `Ce projet m'a permis de comprendre à quel point une bonne organisation du code et une interface utilisateur bien pensée sont essentielles. J'ai également appris à développer un back-office sécurisé en PHP avec du SQL pour la gestion du site. De plus, j'ai acquis de nouvelles compétences en hébergement web, en assurant la mise en ligne et la maintenance du site.`,
    buttons: [
      {
  ...
  },
  {
    ...
    projectObjective: `L'objectif est de permettre de prendre des notes rapidement tout en restant sur la même page.`,
    experienceGaind: `Créer mon extension web m'a appris à structurer un projet, faire des choix techniques et optimiser l'expérience utilisateur. J'ai renforcé mes compétences en front-end et gestion du stockage local. Voir mon idée devenir un outil fonctionnel a été une grande satisfaction.`,
    buttons: [
      {
        link: `#`,
        color: `gold`,
